    ...
    public class CadastrosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cadastros != null ? 
                          ...
                          Problem("Entity set 'DataContext.Cadastros'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
